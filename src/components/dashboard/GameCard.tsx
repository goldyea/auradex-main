...
const GameCard = ({
  ...
  return (
    <div
      className="rounded-xl shadow-lg p-0 h-full w-full flex flex-col justify-between transition-transform duration-300 hover:scale-105 cursor-pointer overflow-hidden"
      onClick={onClick}
    >
